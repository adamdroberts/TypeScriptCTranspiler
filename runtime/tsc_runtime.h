...
tsc_str_t* tsc_str_from_char_code_values(const struct tsc_array* values);
...
bool tsc_str_is_well_formed(const tsc_str_t* s);
tsc_str_t* tsc_str_to_well_formed(const tsc_str_t* s);
...
tsc_value_t tsc_child_process_spawn(const tsc_str_t* file, const struct tsc_array* args, const tsc_str_t* cwd, const struct tsc_array* env, const tsc_str_t* shell, const tsc_str_t* argv0, bool pipe_stdin, bool ignore_stdin, bool pipe_stdout, bool ignore_stdout, bool inherit_stdout, bool pipe_stderr, bool ignore_stderr, bool inherit_stderr, bool detached, double uid, double gid, double timeout_ms, int kill_signal, tsc_value_t abort_signal);
