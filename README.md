...
| 4 | Multi-file module graph — flat namespace, local imports, topological init, type-only imports, barrel/star/default re-exports, default class/anonymous-function/export-assignment imports, and source-byte-preserving import-attribute trivia before `with` | ✅ |
