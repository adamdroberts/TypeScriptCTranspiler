...
Each of the following compiles and runs end-to-end. See [`tests/e2e/cases/`](tests/e2e/cases/) for the full 803-case suite and [`docs/done.md`](docs/done.md) for the complete capability inventory.
...
| `tests/e2e/cases/` | 803 test dirs — `in.ts` + optional support files + `expected.stdout` or `expected.exitcode` |
