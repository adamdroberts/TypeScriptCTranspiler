...
- **Modules remainder** — runtime-shaped dynamic-import options/specifiers without a finite AOT proof, top-level await, and exact cyclic evaluation across every live-binding/abrupt-completion partition.
