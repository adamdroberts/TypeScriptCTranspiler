...
| 4 | Multi-file module graph — flat namespace, local imports, topological init, type-only imports, barrel/star/default re-exports, default class/anonymous-function/export-assignment imports, source-byte-preserving import-attribute trivia before `with`, and static JSON Modules with one shared default synthetic binding | ✅ |
