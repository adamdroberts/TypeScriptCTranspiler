...
function stringUtf16ExoticWidthSource(width: number): string {
    return [
        ...
        "        descriptors[key].value.charCodeAt(0) !== expectedUnits[index] ||",
        "        directAt === undefined || directAt.charCodeAt(0) !== expectedUnits[index] ||",
        "        relativeAt === undefined || relativeAt.charCodeAt(0) !== expectedUnits[index] ||",
        "        genericAt === undefined || genericAt.charCodeAt(0) !== expectedUnits[index]) valid = false;",
        "}",
