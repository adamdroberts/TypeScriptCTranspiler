...
async function consume(iterator: any): Promise<string> {
    for await (const item of iterator) {
        ...
        await Promise.reject("sixty-first-rejection");
        break;
    }
...
consume(iterator).then((value: string): void => {
    console.log("body-sixty-one-awaits-rejected: unexpected", value);
}, (reason: any): void => {
    console.log("body-sixty-one-awaits-rejected:", reason);
});
