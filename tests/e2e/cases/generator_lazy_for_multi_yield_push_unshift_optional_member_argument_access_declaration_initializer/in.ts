let pushSource: any = null;
let pushKey: string = "label";
let unshiftSource: any = { label: "unshift-before" };

function* multiYieldPushOptionalMemberArgumentAccessDeclarationInitializer(): Generator<string, string, any> {
    for (
...
function* multiYieldUnshiftOptionalMemberArgumentAccessDeclarationInitializer(): Generator<string, string, any> {
    for (
...
const pushIterator = multiYieldPushOptionalMemberArgumentAccessDeclarationInitializer();
...
const unshiftIterator = multiYieldUnshiftOptionalMemberArgumentAccessDeclarationInitializer();
