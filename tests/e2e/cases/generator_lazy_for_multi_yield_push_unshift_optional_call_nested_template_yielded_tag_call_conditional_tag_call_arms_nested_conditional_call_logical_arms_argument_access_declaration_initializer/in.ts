...
function* pushNestedConditionalCallLogicalArms(): Generator<string, string, any> {
    for (
                ...
                (yield "push-selector")
                    ? getPushArm(
                        (yield "push-nested-selector")
                            ? ((yield "push-true-left") && pushNestedCall?.(yield "push-true-call"))
                            : ((yield "push-false-left") || pushNestedCall?.(yield "push-false-call"))
...
function* unshiftNestedConditionalCallLogicalArms(): Generator<string, string, any> {
    for (
                ...
                (yield "unshift-selector")
                    ...
                    : getUnshiftArm(
                        (yield "unshift-nested-selector")
                            ? ((yield "unshift-true-left") && unshiftNestedCall?.(yield "unshift-true-call"))
                            : ((yield "unshift-false-left") || unshiftNestedCall?.(yield "unshift-false-call"))
...
const pushIterator = pushNestedConditionalCallLogicalArms();
...
const pushSixth: any = pushIterator.next("push-true-call-value");
...
const unshiftIterator = unshiftNestedConditionalCallLogicalArms();
...
const unshiftSixth: any = unshiftIterator.next("unshift-false-call-value");
