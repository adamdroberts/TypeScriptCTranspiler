...
declaration(true).catch((reason) => console.log("declaration-throw:", reason, trace));
declaration(false).then((result) => console.log("declaration-catch:", result, trace));
new Worker().run(true).catch((reason) => console.log("method-throw:", reason, trace));
new Worker().run(false).then((result) => console.log("method-catch:", result, trace));
value(true).catch((reason) => console.log("value-throw:", reason, trace));
