...
function* pushLogicalTreeArms(): Generator<string, string, any> {
    for (
...
function* unshiftLogicalTreeArms(): Generator<string, string, any> {
    for (
...
const pushIterator = pushLogicalTreeArms();
...
const unshiftIterator = unshiftLogicalTreeArms();
