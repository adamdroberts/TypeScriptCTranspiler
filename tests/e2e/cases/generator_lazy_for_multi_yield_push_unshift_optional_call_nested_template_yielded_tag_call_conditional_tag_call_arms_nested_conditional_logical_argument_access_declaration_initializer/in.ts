                ...
                (yield "push-selector")
                    ? getPushArm(
                        (yield "push-nested-selector")
                            ? ((yield "push-logical-left") && (
                                (yield "push-logical-middle") ||
                                getPushNested((yield "push-nested-seed"))`nested-${yield "push-nested-value"}`
                            ))
                ...
                (yield "unshift-selector")
                    ...
                    : getUnshiftArm(
                        (yield "unshift-nested-selector")
                            ...
                            : ((yield "unshift-logical-left") || (
                                (yield "unshift-logical-middle") ??
                                getUnshiftNested((yield "unshift-nested-seed"))`nested-${yield "unshift-nested-value"}`
                            ))
...
const pushSeventh: any = pushIterator.next("push-nested-seed-value");
console.log("push-seventh", pushEvents.join(","), pushReceiver.join(","), pushSeventh.done, pushSeventh.value);
const pushEighth: any = pushIterator.next("push-nested-value");
...
const unshiftSeventh: any = unshiftIterator.next("unshift-nested-seed-value");
console.log("unshift-seventh", unshiftEvents.join(","), unshiftReceiver.join(","), unshiftSeventh.done, unshiftSeventh.value);
const unshiftEighth: any = unshiftIterator.next("unshift-nested-value");
