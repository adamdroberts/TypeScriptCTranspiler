...
copyFileSync(syncFile, syncCopy, undefined, mark("copy"));
renameSync(syncCopy, syncRenamed, mark("rename"));
linkSync(syncRenamed, syncHard, mark("link"));
fs.symlinkSync(syncRenamed, syncLink, undefined, mark("symlink"));
truncateSync(syncRenamed, undefined, mark("truncate"));
...
fs.rmdirSync(syncEmpty, undefined, mark("rmdir"));
...
fs.promises.copyFile(promiseFile, promiseCopy, undefined, mark("pcopy"));
fs.promises.rename(promiseCopy, promiseRenamed, mark("prename"));
fs.promises.link(promiseRenamed, promiseHard, mark("plink"));
fs.promises.symlink(promiseRenamed, promiseLink, undefined, mark("psymlink"));
fs.promises.truncate(promiseRenamed, undefined, mark("ptruncate"));
...
fs.promises.rmdir(promiseEmpty, undefined, mark("prmdir"));
