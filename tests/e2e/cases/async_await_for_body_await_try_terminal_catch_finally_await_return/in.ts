...
report("for-return-success", run(false, false, false))
    .then((_value) => report("for-return-terminal-reject", run(false, true, false)))
    .then((_value) => report("for-return-cleanup-reject", run(false, false, true)))
    .then((_value) => report("for-return-stage-reject", run(true, false, false)));
