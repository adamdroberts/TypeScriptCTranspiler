...
async function consume(iterator: any): Promise<string> {
    for await (const item of iterator) {
        ...
        await Promise.reject("fifty-third-rejection");
        break;
    }
...
consume(iterator).then((value: string): void => {
    console.log("body-fifty-three-awaits-rejected: unexpected", value);
}, (reason: any): void => {
    console.log("body-fifty-three-awaits-rejected:", reason);
});
