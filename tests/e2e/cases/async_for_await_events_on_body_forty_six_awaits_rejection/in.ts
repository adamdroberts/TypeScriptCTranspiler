...
async function consume(iterator: any): Promise<string> {
    for await (const item of iterator) {
        ...
        await Promise.reject("forty-sixth-rejection");
        break;
    }
...
consume(iterator).then((value: string): void => {
    console.log("body-forty-six-awaits-rejected: unexpected", value);
}, (reason: any): void => {
    console.log("body-forty-six-awaits-rejected:", reason);
});
