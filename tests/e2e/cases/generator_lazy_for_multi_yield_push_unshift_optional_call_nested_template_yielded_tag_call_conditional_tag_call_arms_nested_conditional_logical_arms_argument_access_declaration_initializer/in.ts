...
function* pushNestedConditionalLogicalArms(): Generator<string, string, any> {
    for (
                ...
                (yield "push-selector")
                    ? getPushArm(
                        (yield "push-nested-selector")
                            ? ((yield "push-true-left") && getPushTrueNested((yield "push-true-seed"))`nested-${yield "push-true-value"}`)
                            : ((yield "push-false-left") || getPushFalseNested((yield "push-false-seed"))`nested-${yield "push-false-value"}`)
...
function* unshiftNestedConditionalLogicalArms(): Generator<string, string, any> {
    for (
                ...
                (yield "unshift-selector")
                    ...
                    : getUnshiftArm(
                        (yield "unshift-nested-selector")
                            ? ((yield "unshift-true-left") && getUnshiftTrueNested((yield "unshift-true-seed"))`nested-${yield "unshift-true-value"}`)
                            : ((yield "unshift-false-left") || getUnshiftFalseNested((yield "unshift-false-seed"))`nested-${yield "unshift-false-value"}`)
...
const pushIterator = pushNestedConditionalLogicalArms();
...
const unshiftIterator = unshiftNestedConditionalLogicalArms();
