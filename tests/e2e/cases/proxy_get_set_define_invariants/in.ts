...
try {
    console.log("get fixed:", Reflect.get(fixedGetProxy, "fixed"));
} catch (e: any) {
...
try {
    console.log("get accessor:", Reflect.get(getterlessProxy, "hidden"));
} catch (e: any) {
    console.log("get accessor:", e);
}

const undefinedGetterProxy: any = new Proxy(getterlessTarget, { get: passGet as any });
console.log("get accessor ok:", String(Reflect.get(undefinedGetterProxy, "hidden")));
...
try {
    console.log("set fixed:", Reflect.set(fixedSetProxy, "fixed", "changed"));
} catch (e: any) {
    console.log("set fixed:", e);
}
console.log("set same:", Reflect.set(fixedSetProxy, "fixed", "fixed"));
...
try {
    console.log("set accessor:", Reflect.set(setterlessProxy, "hidden", "value"));
} catch (e: any) {
...
try {
    console.log("define closed:", Reflect.defineProperty(closedProxy, "x", { value: 1, configurable: true }));
} catch (e: any) {
...
try {
    console.log("define new fixed:", Reflect.defineProperty(newNonConfigProxy, "x", { value: 1, configurable: false }));
} catch (e: any) {
...
try {
    console.log("define configurable fixed:", Reflect.defineProperty(configurableProxy, "x", { configurable: false }));
} catch (e: any) {
...
try {
    console.log("define fixed changed:", Reflect.defineProperty(fixedDefineProxy, "x", { value: 2 }));
} catch (e: any) {
    console.log("define fixed changed:", e);
}
console.log("define fixed same:", Reflect.defineProperty(fixedDefineProxy, "x", { value: 1 }));
...
try {
    console.log("define accessor data:", Reflect.defineProperty(accessorDefineProxy, "x", { value: 1 }));
} catch (e: any) {
