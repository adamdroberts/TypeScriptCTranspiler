...
function* dynamicArray(): Generator<any, any, any> {
    return [...[...(yield ["prompt"]), "inner"], "middle", ...[...(yield ["tail"])]];
}

function* typedObject(): Generator<any, NestedObjectResult, any> {
    return {
        ...{ ...(yield { first: 1 }) },
        middle: yield 2,
        ...{ ...(yield { last: 3 }) },
...
function* dynamicObject(): Generator<any, any, any> {
    return {
        ...{ ...(yield { first: "prompt-first" }), extra: "inner" },
...
const typedObjectResult = typedObjectDone.value as NestedObjectResult;
console.log(
    "typed-object",
