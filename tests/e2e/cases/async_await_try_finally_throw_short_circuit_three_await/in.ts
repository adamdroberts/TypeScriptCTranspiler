...
class Worker {
    async run(): Promise<string> {
        try {
            throw await delay(1, "") || await delay(1, "method-two") || await delay(1, "method-three");
        } finally {
...
const value = async (): Promise<string> => {
    try {
        throw await delay(1, null) ?? await delay(1, "arrow-two") ?? await delay(1, "arrow-three");
    } finally {
...
async function rejected(): Promise<string> {
    try {
        throw await delayedRejectAfter(1, "source-rejection") && await delay(1, "unused-two") && await delay(1, "unused-three");
    } finally {
