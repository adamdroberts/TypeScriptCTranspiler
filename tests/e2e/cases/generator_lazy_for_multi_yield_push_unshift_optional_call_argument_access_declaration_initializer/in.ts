...
let unshiftCallback: any = (): any => "unshift-after";

function* multiYieldPushOptionalCallArgumentAccessDeclarationInitializer(): Generator<string, string, any> {
    for (
...
function* multiYieldUnshiftOptionalCallArgumentAccessDeclarationInitializer(): Generator<string, string, any> {
    for (
...
const pushIterator = multiYieldPushOptionalCallArgumentAccessDeclarationInitializer();
...
const unshiftIterator = multiYieldUnshiftOptionalCallArgumentAccessDeclarationInitializer();
