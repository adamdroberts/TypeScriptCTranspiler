...
async function consume(iterator: any): Promise<string> {
    for await (const item of iterator) {
        ...
        await Promise.reject("forty-second-rejection");
        break;
    }
...
consume(iterator).then((value: string): void => {
    console.log("body-forty-two-awaits-rejected: unexpected", value);
}, (reason: any): void => {
    console.log("body-forty-two-awaits-rejected:", reason);
});
