...
report("throw-success", run(false, false, false))
    .then((_value) => report("throw-terminal-reject", run(false, true, false)))
    .then((_value) => report("throw-cleanup-reject", run(false, false, true)))
    .then((_value) => report("throw-stage-reject", run(true, false, false)));
