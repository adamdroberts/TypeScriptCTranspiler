...
const unused_crypto_named_alias_hash_call = createHashAlias("sha256");
...
const unused_crypto_hash_alias_digest_call = createHashAlias("sha256").update("dead_crypto_hash_alias_digest").digest("hex");
...
const unused_crypto_hash_alias_digest_upper_call = (createHashAlias("sha256").update("dead_crypto_hash_alias_digest_upper_call").digest("hex").toUpperCase(), "dead_crypto_hash_alias_digest_upper_call_marker".length);
...
const unused_promise_resolve_crypto_hash_alias_digest_upper_call = Promise.resolve((createHashAlias("sha256").update("dead_promise_resolve_crypto_hash_alias_digest_upper_call").digest("hex").toUpperCase(), "dead_promise_resolve_crypto_hash_alias_digest_upper_call_marker"));
...
const unused_promise_resolve_crypto_named_alias_hash_digest_call = Promise.resolve(createHashAlias("sha256").update(Buffer.from("dead_promise_resolve_crypto_named_alias_hash_digest")).digest("hex"));
...
const unused_array_splice_call = ["dead_array_splice", "dead_array_splice_tail"].splice(0, 1, "dead_array_splice_insert");
...
const unused_array_from_set_splice_call = Array.from(new Set(["dead_array_from_set_splice", "dead_array_from_set_splice_tail"])).splice(1, 0, "dead_array_from_set_splice_insert");
...
const unused_error_property_names_with_call = Object.getOwnPropertyNames(new Error("dead_error_property_names_with")).with(3, "dead_error_property_names_with_replacement");
const unused_error_reflect_own_keys_with_call = Reflect.ownKeys(new AggregateError(["dead_error_reflect_own_keys_with_item"], "dead_error_reflect_own_keys_with")).with(3, "dead_error_reflect_own_keys_with_replacement");
...
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_error_descriptor_nested_reflect_get_value_upper_call = Reflect.get(Object.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_nested_reflect_get_value_upper"), "message")!, "value", "dead_error_descriptor_nested_reflect_get_value_ignored")!, "value", { dead_error_descriptor_nested_reflect_get_value_receiver: true }).toUpperCase();
...
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_regexp_descriptor_nested_reflect_get_value_to_string_call = Reflect.get(Reflect.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_nested_reflect_get_value_to_string/g, "lastIndex")!, "value", "dead_regexp_descriptor_nested_reflect_get_value_ignored")!, "value", { dead_regexp_descriptor_nested_reflect_get_value_receiver: true }).toString().length;
...
const unused_error_descriptors_reflect_own_keys_with_call = Reflect.ownKeys(Object.getOwnPropertyDescriptors(new TypeError("dead_error_descriptors_reflect_own_keys_with"))).with(3, "dead_error_descriptors_reflect_own_keys_with_replacement");
...
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_error_descriptor_get_prototype_ignored_call = Object.getPrototypeOf(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_get_prototype_ignored"), "message")!, "dead_error_descriptor_get_prototype_ignored_arg");
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_error_descriptor_reflect_get_prototype_ignored_call = Reflect.getPrototypeOf(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_reflect_get_prototype_ignored"), "message")!, "dead_error_descriptor_reflect_get_prototype_ignored_arg");
...
const unused_regexp_descriptor_is_extensible_call = Reflect.isExtensible(Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_is_extensible/g, "lastIndex")!);
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_error_descriptor_object_is_extensible_ignored_call = Object.isExtensible(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_object_is_extensible_ignored"), "message")!, "dead_error_descriptor_object_is_extensible_ignored_arg");
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_regexp_descriptor_reflect_is_extensible_ignored_call = Reflect.isExtensible(Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_reflect_is_extensible_ignored/g, "lastIndex")!, "dead_regexp_descriptor_reflect_is_extensible_ignored_arg");
const unused_error_descriptor_freeze_call = Object.freeze(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_freeze"), "message")!);
...
const unused_error_descriptor_spread_keys_with_call = Object.keys({ ...Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_spread_keys_with"), "message")! }).with(3, "dead_error_descriptor_spread_keys_with_replacement");
const unused_regexp_descriptor_assign_names_with_call = Object.getOwnPropertyNames(Object.assign({} as { value?: unknown; writable?: boolean; enumerable?: boolean; configurable?: boolean }, Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_assign_names_with/g, "lastIndex")!)).with(3, "dead_regexp_descriptor_assign_names_with_replacement");
const unused_error_descriptor_spread_values_with_call = Object.values({ ...Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_spread_values_with"), "message")! }).with(1, false);
const unused_regexp_descriptor_assign_entries_with_call = Object.entries(Object.assign({} as { value?: unknown; writable?: boolean; enumerable?: boolean; configurable?: boolean }, Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_assign_entries_with/g, "lastIndex")!)).with(3, ["dead_regexp_descriptor_assign_entries_with_key", false]);
const unused_error_descriptor_from_entries_keys_with_call = Object.keys(Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_from_entries_keys_with"), "message")!))).with(3, "dead_error_descriptor_from_entries_keys_with_replacement");
const unused_regexp_descriptor_from_entries_values_with_call = Object.values(Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_from_entries_values_with/g, "lastIndex")!))).with(1, "dead_regexp_descriptor_from_entries_values_with_replacement");
const unused_error_descriptor_define_property_call = Object.defineProperty({} as { dead_error_descriptor_define_property: string }, "dead_error_descriptor_define_property", Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_define_property"), "message")!);
const unused_regexp_descriptor_define_properties_call = Object.defineProperties({} as { dead_regexp_descriptor_define_properties: number }, { dead_regexp_descriptor_define_properties: Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_define_properties/g, "lastIndex")! });
const unused_error_descriptor_reflect_define_property_call = Reflect.defineProperty({} as { dead_error_descriptor_reflect_define_property: string }, "dead_error_descriptor_reflect_define_property", Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_reflect_define_property"), "message")!);
const unused_regexp_descriptor_object_create_map_call = Object.create(null, { dead_regexp_descriptor_object_create_map: Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_object_create_map/g, "lastIndex")! });
const unused_error_descriptor_object_prototype_has_own_call = Object.prototype.hasOwnProperty.call(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_object_prototype_has_own"), "message")!, "value", "dead_error_descriptor_object_prototype_has_own_ignored");
const unused_regexp_descriptor_object_prototype_property_is_enumerable_call = Object.prototype.propertyIsEnumerable.call(Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_object_prototype_property_is_enumerable/g, "lastIndex")!, "enumerable", "dead_regexp_descriptor_object_prototype_property_is_enumerable_ignored");
const unused_error_descriptor_object_prototype_is_prototype_of_call = Object.prototype.isPrototypeOf.call(Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_object_prototype_is_prototype_of"), "message")!, {});
const unused_error_descriptor_has_own_property_call = Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_has_own_property"), "message")!.hasOwnProperty("value", "dead_error_descriptor_has_own_property_ignored");
const unused_regexp_descriptor_property_is_enumerable_call = Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_property_is_enumerable/g, "lastIndex")!.propertyIsEnumerable("enumerable", "dead_regexp_descriptor_property_is_enumerable_ignored");
...
const unused_promise_resolve_error_descriptor_reflect_get_enumerable_receiver_call = Promise.resolve(Reflect.get(Object.getOwnPropertyDescriptor(new Error("dead_promise_resolve_error_descriptor_reflect_get_enumerable_receiver"), "message")!, "enumerable", { dead_promise_resolve_error_descriptor_reflect_get_enumerable_receiver_arg: true }));
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_promise_resolve_error_descriptor_nested_reflect_get_enumerable_call = Promise.resolve(Reflect.get(Object.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(new Error("dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable"), "message")!, "enumerable", "dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable_ignored")!, "value", { dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable_receiver: true }));
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_promise_resolve_error_absent_descriptor_call = Promise.resolve(Object.getOwnPropertyDescriptor(new Error("dead_promise_resolve_error_absent_descriptor"), "missing", "dead_promise_resolve_error_absent_descriptor_ignored"));
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
const unused_promise_resolve_regexp_absent_reflect_descriptor_call = Promise.resolve(Reflect.getOwnPropertyDescriptor(/dead_promise_resolve_regexp_absent_reflect_descriptor/g, "source", "dead_promise_resolve_regexp_absent_reflect_descriptor_ignored"));
...
const unused_regexp_descriptor_object_prototype_to_locale_string_upper_call = (Object.prototype.toLocaleString.call(Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_object_prototype_to_locale_string_upper/g, "lastIndex")!).toUpperCase(), "dead_regexp_descriptor_object_prototype_to_locale_string_upper_marker".length);
const unused_error_descriptor_to_string_length_read = Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_to_string_length_target"), "message")!.toString().length + "dead_error_descriptor_to_string_length_read".length;
const unused_regexp_descriptor_to_locale_string_upper_call = (Object.getOwnPropertyDescriptor(/dead_regexp_descriptor_to_locale_string_upper/g, "lastIndex")!.toLocaleString().toUpperCase(), "dead_regexp_descriptor_to_locale_string_upper_marker".length);
...
const unused_error_descriptor_value_of_ignored_value_upper_call = Object.getOwnPropertyDescriptor(new Error("dead_error_descriptor_value_of_ignored_value_upper"), "message")!.valueOf("dead_error_descriptor_value_of_ignored").value.toUpperCase();
...
const unused_object_freeze_date_call = Object.freeze(new Date("2020-01-10T11:12:13Z"));
const unused_object_seal_error_call = Object.seal(new Error("dead_object_seal_error"));
const unused_object_prevent_extensions_regexp_call = Object.preventExtensions(/dead_object_prevent_extensions_regexp/g);
...
const unused_reflect_prevent_extensions_event_call = Reflect.preventExtensions(new Event("dead_reflect_prevent_extensions_event"));
const unused_reflect_prevent_extensions_event_target_call = Reflect.preventExtensions(new EventTarget());
...
new (Array as any)();
new (Array as any)("top_level_dead_new_array_length".length);
new (Array as any)("top_level_dead_new_array_item", "top_level_dead_new_array_item_tail");
(Array as any)();
(Array as any)("top_level_dead_callable_array_length".length);
(Array as any)("top_level_dead_callable_array_item", "top_level_dead_callable_array_item_tail");
...
createHashAlias("sha256").update("top_level_dead_crypto_hash_alias_digest").digest("hex");
...
(createHashAlias("sha256").update("top_level_dead_crypto_hash_alias_digest_upper_call").digest("hex").toUpperCase(), "top_level_dead_crypto_hash_alias_digest_upper_call_marker".length);
...
Promise.resolve((createHashAlias("sha256").update("top_level_dead_promise_resolve_crypto_hash_alias_digest_upper_call").digest("hex").toUpperCase(), "top_level_dead_promise_resolve_crypto_hash_alias_digest_upper_call_marker"));
...
["top_level_dead_array_splice", "top_level_dead_array_splice_tail"].splice(0, 1, "top_level_dead_array_splice_insert");
...
Array.from(new Set(["top_level_dead_array_from_set_splice", "top_level_dead_array_from_set_splice_tail"])).splice(1, 0, "top_level_dead_array_from_set_splice_insert");
...
Object.getOwnPropertyNames(new TypeError("top_level_dead_error_property_names_with")).with(3, "top_level_dead_error_property_names_with_replacement");
Reflect.ownKeys(new URIError("top_level_dead_error_reflect_own_keys_with")).with(3, "top_level_dead_error_reflect_own_keys_with_replacement");
...
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Reflect.get(Object.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_nested_reflect_get_value_upper"), "message")!, "value", "top_level_dead_error_descriptor_nested_reflect_get_value_ignored")!, "value", { top_level_dead_error_descriptor_nested_reflect_get_value_receiver: true }).toUpperCase();
...
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Reflect.get(Reflect.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_nested_reflect_get_value_to_string/g, "lastIndex")!, "value", "top_level_dead_regexp_descriptor_nested_reflect_get_value_ignored")!, "value", { top_level_dead_regexp_descriptor_nested_reflect_get_value_receiver: true }).toString().length;
...
Reflect.ownKeys(Object.getOwnPropertyDescriptors(new TypeError("top_level_dead_error_descriptors_reflect_own_keys_with"))).with(3, "top_level_dead_error_descriptors_reflect_own_keys_with_replacement");
...
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Object.getPrototypeOf(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_get_prototype_ignored"), "message")!, "top_level_dead_error_descriptor_get_prototype_ignored_arg");
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Reflect.getPrototypeOf(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_reflect_get_prototype_ignored"), "message")!, "top_level_dead_error_descriptor_reflect_get_prototype_ignored_arg");
...
Reflect.isExtensible(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_is_extensible/g, "lastIndex")!);
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Object.isExtensible(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_object_is_extensible_ignored"), "message")!, "top_level_dead_error_descriptor_object_is_extensible_ignored_arg");
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Reflect.isExtensible(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_reflect_is_extensible_ignored/g, "lastIndex")!, "top_level_dead_regexp_descriptor_reflect_is_extensible_ignored_arg");
Object.freeze(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_freeze"), "message")!);
...
Object.keys({ ...Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_spread_keys_with"), "message")! }).with(3, "top_level_dead_error_descriptor_spread_keys_with_replacement");
Object.getOwnPropertyNames(Object.assign({} as { value?: unknown; writable?: boolean; enumerable?: boolean; configurable?: boolean }, Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_assign_names_with/g, "lastIndex")!)).with(3, "top_level_dead_regexp_descriptor_assign_names_with_replacement");
Object.values({ ...Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_spread_values_with"), "message")! }).with(1, false);
Object.entries(Object.assign({} as { value?: unknown; writable?: boolean; enumerable?: boolean; configurable?: boolean }, Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_assign_entries_with/g, "lastIndex")!)).with(3, ["top_level_dead_regexp_descriptor_assign_entries_with_key", false]);
Object.keys(Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_from_entries_keys_with"), "message")!))).with(3, "top_level_dead_error_descriptor_from_entries_keys_with_replacement");
Object.values(Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_from_entries_values_with/g, "lastIndex")!))).with(1, "top_level_dead_regexp_descriptor_from_entries_values_with_replacement");
Object.defineProperty({} as { top_level_dead_error_descriptor_define_property: string }, "top_level_dead_error_descriptor_define_property", Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_define_property"), "message")!);
Object.defineProperties({} as { top_level_dead_regexp_descriptor_define_properties: number }, { top_level_dead_regexp_descriptor_define_properties: Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_define_properties/g, "lastIndex")! });
Reflect.defineProperty({} as { top_level_dead_error_descriptor_reflect_define_property: string }, "top_level_dead_error_descriptor_reflect_define_property", Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_reflect_define_property"), "message")!);
Object.create(null, { top_level_dead_regexp_descriptor_object_create_map: Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_object_create_map/g, "lastIndex")! });
Object.prototype.hasOwnProperty.call(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_object_prototype_has_own"), "message")!, "value", "top_level_dead_error_descriptor_object_prototype_has_own_ignored");
Object.prototype.propertyIsEnumerable.call(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_object_prototype_property_is_enumerable/g, "lastIndex")!, "enumerable", "top_level_dead_regexp_descriptor_object_prototype_property_is_enumerable_ignored");
Object.prototype.isPrototypeOf.call(Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_object_prototype_is_prototype_of"), "message")!, {});
Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_has_own_property"), "message")!.hasOwnProperty("value", "top_level_dead_error_descriptor_has_own_property_ignored");
Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_property_is_enumerable/g, "lastIndex")!.propertyIsEnumerable("enumerable", "top_level_dead_regexp_descriptor_property_is_enumerable_ignored");
...
Promise.resolve(Reflect.get(Object.getOwnPropertyDescriptor(new Error("top_level_dead_promise_resolve_error_descriptor_reflect_get_enumerable_receiver"), "message")!, "enumerable", { top_level_dead_promise_resolve_error_descriptor_reflect_get_enumerable_receiver_arg: true }));
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Promise.resolve(Reflect.get(Object.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(new Error("top_level_dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable"), "message")!, "enumerable", "top_level_dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable_ignored")!, "value", { top_level_dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable_receiver: true }));
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Promise.resolve(Object.getOwnPropertyDescriptor(new Error("top_level_dead_promise_resolve_error_absent_descriptor"), "missing", "top_level_dead_promise_resolve_error_absent_descriptor_ignored"));
// @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
Promise.resolve(Reflect.getOwnPropertyDescriptor(/top_level_dead_promise_resolve_regexp_absent_reflect_descriptor/g, "source", "top_level_dead_promise_resolve_regexp_absent_reflect_descriptor_ignored"));
...
(Object.prototype.toLocaleString.call(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_object_prototype_to_locale_string_upper/g, "lastIndex")!).toUpperCase(), "top_level_dead_regexp_descriptor_object_prototype_to_locale_string_upper_marker".length);
Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_to_string_length_target"), "message")!.toString().length + "top_level_dead_error_descriptor_to_string_length_read".length;
(Object.getOwnPropertyDescriptor(/top_level_dead_regexp_descriptor_to_locale_string_upper/g, "lastIndex")!.toLocaleString().toUpperCase(), "top_level_dead_regexp_descriptor_to_locale_string_upper_marker".length);
...
Object.getOwnPropertyDescriptor(new Error("top_level_dead_error_descriptor_value_of_ignored_value_upper"), "message")!.valueOf("top_level_dead_error_descriptor_value_of_ignored").value.toUpperCase();
...
Object.freeze(new Date("2020-01-11T12:13:14Z"));
Object.seal(new TypeError("top_level_dead_object_seal_type_error"));
Object.preventExtensions(/top_level_dead_object_prevent_extensions_regexp/g);
...
Reflect.preventExtensions(new Event("top_level_dead_reflect_prevent_extensions_event"));
Reflect.preventExtensions(new EventTarget());
...
function usedLocal(value: number): number {
    ...
    new (Array as any)();
    new (Array as any)("local_dead_new_array_length".length);
    new (Array as any)("local_dead_new_array_item", "local_dead_new_array_item_tail");
    (Array as any)();
    (Array as any)("local_dead_callable_array_length".length);
    (Array as any)("local_dead_callable_array_item", "local_dead_callable_array_item_tail");
    ...
    createHashAlias("sha256").update("local_dead_crypto_hash_alias_digest").digest("hex");
    ...
    (createHashAlias("sha256").update("local_dead_crypto_hash_alias_digest_upper_call").digest("hex").toUpperCase(), "local_dead_crypto_hash_alias_digest_upper_call_marker".length);
    ...
    Promise.resolve((createHashAlias("sha256").update("local_dead_promise_resolve_crypto_hash_alias_digest_upper_call").digest("hex").toUpperCase(), "local_dead_promise_resolve_crypto_hash_alias_digest_upper_call_marker"));
    ...
    ["local_dead_array_splice", "local_dead_array_splice_tail"].splice(0, 1, "local_dead_array_splice_insert");
    ...
    Array.from(new Set(["local_dead_array_from_set_splice", "local_dead_array_from_set_splice_tail"])).splice(1, 0, "local_dead_array_from_set_splice_insert");
    ...
    Object.getOwnPropertyNames(new SyntaxError("local_dead_error_property_names_with")).with(3, "local_dead_error_property_names_with_replacement");
    Reflect.ownKeys(new ReferenceError("local_dead_error_reflect_own_keys_with")).with(3, "local_dead_error_reflect_own_keys_with_replacement");
    ...
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Reflect.get(Object.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_nested_reflect_get_value_upper"), "message")!, "value", "local_dead_error_descriptor_nested_reflect_get_value_ignored")!, "value", { local_dead_error_descriptor_nested_reflect_get_value_receiver: true }).toUpperCase();
    ...
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Reflect.get(Reflect.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_nested_reflect_get_value_to_string/g, "lastIndex")!, "value", "local_dead_regexp_descriptor_nested_reflect_get_value_ignored")!, "value", { local_dead_regexp_descriptor_nested_reflect_get_value_receiver: true }).toString().length;
    ...
    Reflect.ownKeys(Object.getOwnPropertyDescriptors(new TypeError("local_dead_error_descriptors_reflect_own_keys_with"))).with(3, "local_dead_error_descriptors_reflect_own_keys_with_replacement");
    ...
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Object.getPrototypeOf(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_get_prototype_ignored"), "message")!, "local_dead_error_descriptor_get_prototype_ignored_arg");
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Reflect.getPrototypeOf(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_reflect_get_prototype_ignored"), "message")!, "local_dead_error_descriptor_reflect_get_prototype_ignored_arg");
    ...
    Reflect.isExtensible(Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_is_extensible/g, "lastIndex")!);
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Object.isExtensible(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_object_is_extensible_ignored"), "message")!, "local_dead_error_descriptor_object_is_extensible_ignored_arg");
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Reflect.isExtensible(Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_reflect_is_extensible_ignored/g, "lastIndex")!, "local_dead_regexp_descriptor_reflect_is_extensible_ignored_arg");
    Object.freeze(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_freeze"), "message")!);
    ...
    Object.keys({ ...Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_spread_keys_with"), "message")! }).with(3, "local_dead_error_descriptor_spread_keys_with_replacement");
    Object.getOwnPropertyNames(Object.assign({} as { value?: unknown; writable?: boolean; enumerable?: boolean; configurable?: boolean }, Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_assign_names_with/g, "lastIndex")!)).with(3, "local_dead_regexp_descriptor_assign_names_with_replacement");
    Object.values({ ...Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_spread_values_with"), "message")! }).with(1, false);
    Object.entries(Object.assign({} as { value?: unknown; writable?: boolean; enumerable?: boolean; configurable?: boolean }, Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_assign_entries_with/g, "lastIndex")!)).with(3, ["local_dead_regexp_descriptor_assign_entries_with_key", false]);
    Object.keys(Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_from_entries_keys_with"), "message")!))).with(3, "local_dead_error_descriptor_from_entries_keys_with_replacement");
    Object.values(Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_from_entries_values_with/g, "lastIndex")!))).with(1, "local_dead_regexp_descriptor_from_entries_values_with_replacement");
    Object.defineProperty({} as { local_dead_error_descriptor_define_property: string }, "local_dead_error_descriptor_define_property", Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_define_property"), "message")!);
    Object.defineProperties({} as { local_dead_regexp_descriptor_define_properties: number }, { local_dead_regexp_descriptor_define_properties: Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_define_properties/g, "lastIndex")! });
    Reflect.defineProperty({} as { local_dead_error_descriptor_reflect_define_property: string }, "local_dead_error_descriptor_reflect_define_property", Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_reflect_define_property"), "message")!);
    Object.create(null, { local_dead_regexp_descriptor_object_create_map: Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_object_create_map/g, "lastIndex")! });
    Object.prototype.hasOwnProperty.call(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_object_prototype_has_own"), "message")!, "value", "local_dead_error_descriptor_object_prototype_has_own_ignored");
    Object.prototype.propertyIsEnumerable.call(Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_object_prototype_property_is_enumerable/g, "lastIndex")!, "enumerable", "local_dead_regexp_descriptor_object_prototype_property_is_enumerable_ignored");
    Object.prototype.isPrototypeOf.call(Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_object_prototype_is_prototype_of"), "message")!, {});
    Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_has_own_property"), "message")!.hasOwnProperty("value", "local_dead_error_descriptor_has_own_property_ignored");
    Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_property_is_enumerable/g, "lastIndex")!.propertyIsEnumerable("enumerable", "local_dead_regexp_descriptor_property_is_enumerable_ignored");
    ...
    Promise.resolve(Reflect.get(Object.getOwnPropertyDescriptor(new Error("local_dead_promise_resolve_error_descriptor_reflect_get_enumerable_receiver"), "message")!, "enumerable", { local_dead_promise_resolve_error_descriptor_reflect_get_enumerable_receiver_arg: true }));
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Promise.resolve(Reflect.get(Object.getOwnPropertyDescriptor(Object.getOwnPropertyDescriptor(new Error("local_dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable"), "message")!, "enumerable", "local_dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable_ignored")!, "value", { local_dead_promise_resolve_error_descriptor_nested_reflect_get_enumerable_receiver: true }));
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Promise.resolve(Object.getOwnPropertyDescriptor(new Error("local_dead_promise_resolve_error_absent_descriptor"), "missing", "local_dead_promise_resolve_error_absent_descriptor_ignored"));
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    Promise.resolve(Reflect.getOwnPropertyDescriptor(/local_dead_promise_resolve_regexp_absent_reflect_descriptor/g, "source", "local_dead_promise_resolve_regexp_absent_reflect_descriptor_ignored"));
    ...
    (Object.prototype.toLocaleString.call(Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_object_prototype_to_locale_string_upper/g, "lastIndex")!).toUpperCase(), "local_dead_regexp_descriptor_object_prototype_to_locale_string_upper_marker".length);
    Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_to_string_length_target"), "message")!.toString().length + "local_dead_error_descriptor_to_string_length_read".length;
    (Object.getOwnPropertyDescriptor(/local_dead_regexp_descriptor_to_locale_string_upper/g, "lastIndex")!.toLocaleString().toUpperCase(), "local_dead_regexp_descriptor_to_locale_string_upper_marker".length);
    ...
    Object.getOwnPropertyDescriptor(new Error("local_dead_error_descriptor_value_of_ignored_value_upper"), "message")!.valueOf("local_dead_error_descriptor_value_of_ignored").value.toUpperCase();
    ...
    Object.freeze(new Date("2020-01-12T13:14:15Z"));
    Object.seal(new RangeError("local_dead_object_seal_range_error"));
    Object.preventExtensions(/local_dead_object_prevent_extensions_regexp/g);
    Reflect.preventExtensions(new Event("local_dead_reflect_prevent_extensions_event"));
    Reflect.preventExtensions(new EventTarget());
...
function absentDescriptorNot(): boolean {
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    return !Object.getOwnPropertyDescriptor(new Error("local_dead_absent_descriptor_not_condition"), "missing", "local_dead_absent_descriptor_not_ignored");
}

function absentDescriptorNullish(): string {
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    return (Object.getOwnPropertyDescriptor(new Error("local_dead_absent_descriptor_nullish_condition"), "missing", "local_dead_absent_descriptor_nullish_ignored") as undefined)
        ?? "kept_absent_descriptor_nullish";
}

function absentDescriptorAndOr(): string {
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    const andValue = (Object.getOwnPropertyDescriptor(new Error("local_dead_absent_descriptor_and_condition"), "missing", "local_dead_absent_descriptor_and_ignored") as unknown as boolean)
        && (console.log("local_dead_absent_descriptor_and_rhs"), true);
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    const orValue = (Reflect.getOwnPropertyDescriptor(/local_dead_absent_descriptor_or_condition/g, "source", "local_dead_absent_descriptor_or_ignored") as unknown as boolean)
        || true;
    return (andValue ? "local_dead_absent_descriptor_and_true" : "kept_absent_descriptor_and_false") + " " +
...
function absentDescriptorSwitchDce(): number {
    // @ts-ignore: intentional ignored-argument coverage for generated-C DCE.
    const local_absent_descriptor_switch_key = ((Object.getOwnPropertyDescriptor(new Error("local_dead_absent_descriptor_switch_condition"), "missing", "local_dead_absent_descriptor_switch_ignored") as undefined)
        ?? "b") as "a" | "b";
    switch (local_absent_descriptor_switch_key) {
        case "a":
            console.log("local_dead_absent_descriptor_switch_a");
            return 197;
        case "b":
            return 198;
        default:
            console.log("local_dead_absent_descriptor_switch_default");
            return 199;
    }
}
