...
const unused_os_user_info_call = nodeOs.userInfo({ encoding: "utf8" });
...
const unused_os_named_user_info_shell_upper_call = osUserInfo({ encoding: "utf8" }).shell.toUpperCase();
...
const unused_buffer_to_string_call = Buffer.from("dead_buffer_to_string_ignored").toString("utf8");
...
const unused_buffer_to_string_upper_call = (Buffer.from("dead_buffer_to_string_upper_call").toString("utf8").toUpperCase(), "dead_buffer_to_string_upper_call_marker".length);
...
const unused_promise_resolve_os_user_info_homedir_read = Promise.resolve(nodeOs.userInfo({ encoding: "utf-8" }).homedir);
...
const unused_promise_resolve_os_named_user_info_shell_upper_call = Promise.resolve(osUserInfo({ encoding: "utf8" }).shell.toUpperCase());
...
const unused_promise_resolve_buffer_to_string_upper_call = Promise.resolve((Buffer.from("dead_promise_resolve_buffer_to_string_upper_call").toString("utf8").toUpperCase(), "dead_promise_resolve_buffer_to_string_upper_call_marker"));
...
Buffer.from("top_level_dead_buffer_to_string_ignored").toString("utf8");
...
(Buffer.from("top_level_dead_buffer_to_string_upper_call").toString("utf8").toUpperCase(), "top_level_dead_buffer_to_string_upper_call_marker".length);
...
Promise.resolve((Buffer.from("top_level_dead_promise_resolve_buffer_to_string_upper_call").toString("utf8").toUpperCase(), "top_level_dead_promise_resolve_buffer_to_string_upper_call_marker"));
...
function usedLocal(value: number): number {
    ...
    Buffer.alloc(2, 65);
    Buffer.allocUnsafe(2);
    Buffer.from("local_dead_buffer_to_string_ignored").toString("utf8");
    ...
    (Buffer.from("local_dead_buffer_to_string_upper_call").toString("utf8").toUpperCase(), "local_dead_buffer_to_string_upper_call_marker".length);
    ...
    Promise.resolve((Buffer.from("local_dead_promise_resolve_buffer_to_string_upper_call").toString("utf8").toUpperCase(), "local_dead_promise_resolve_buffer_to_string_upper_call_marker"));
