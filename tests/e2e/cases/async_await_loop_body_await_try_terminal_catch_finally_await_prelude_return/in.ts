...
report("prelude-return-success", run(false, false, false))
    .then((_value) => report("prelude-return-terminal-reject", run(false, true, false)))
    .then((_value) => report("prelude-return-cleanup-reject", run(false, false, true)))
    .then((_value) => report("prelude-return-stage-reject", run(true, false, false)));
