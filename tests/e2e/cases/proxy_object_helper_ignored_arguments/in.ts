...
console.log("proto:", Object.getPrototypeOf(proxy, mark("g")).marker);
console.log("set:", Object.setPrototypeOf(proxy, nextProto, mark("s")) === proxy, Object.getPrototypeOf(target).marker);
console.log("ext:", Object.isExtensible(proxy, mark("e")));
console.log("prevent:", Object.preventExtensions(proxy, mark("p")) === proxy, Object.isExtensible(target));
