...
report("for-prelude-return-success", run(false, false, false))
    .then((_value) => report("for-prelude-return-terminal-reject", run(false, true, false)))
    .then((_value) => report("for-prelude-return-cleanup-reject", run(false, false, true)))
    .then((_value) => report("for-prelude-return-stage-reject", run(true, false, false)));
