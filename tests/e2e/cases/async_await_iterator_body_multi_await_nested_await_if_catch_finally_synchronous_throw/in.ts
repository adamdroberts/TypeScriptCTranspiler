...
async function runOf(stageReject: boolean, sourceReject: boolean, recoveryReject: boolean, catchTerminalReject: boolean, cleanupReject: boolean): Promise<string> {
...
async function runIn(stageReject: boolean, sourceReject: boolean, recoveryReject: boolean, catchTerminalReject: boolean, cleanupReject: boolean): Promise<string> {
...
report("of-success", runOf(false, false, false, false, false))
    .then((_value) => report("of-source-reject", runOf(false, true, false, false, false)))
    .then((_value) => report("of-stage-reject", runOf(true, false, false, false, false)))
    .then((_value) => report("of-recovery-reject", runOf(true, false, true, false, false)))
    ...
    .then((_value) => report("in-source-reject", runIn(false, true, false, false, false)))
    .then((_value) => report("in-stage-reject", runIn(true, false, false, false, false)))
    .then((_value) => report("in-recovery-reject", runIn(true, false, true, false, false)))
