...
| `dynamic_require` | top-level finite const string `require(name)` resolved as an AOT module edge, including static concatenation, template expressions, and side-effect-only conditional alternatives |
