...
- Chained CommonJS object-literal `exports = module.exports = { ... }` assignments expose static named metadata and preserve require-bound whole-object reads. Test: `node_modules_commonjs_module_exports_object_chain_named`
