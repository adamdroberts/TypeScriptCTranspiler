...
- CommonJS whole-value object chains such as `module.exports = exports.default = { ... }` assign `exports.default` to the same emitted static object used for default imports and require-bound whole-object reads. Test: `node_modules_commonjs_module_exports_object_value_chain`
