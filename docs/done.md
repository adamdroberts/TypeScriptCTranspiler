...
| `function_integrity` | stable boxed direct function identity, own length/name metadata, typed function Object/Reflect helpers, function seal/freeze state, and trapless function Proxy integrity forwarding |
...
| `proxy_function_prototype_invariants` | function Proxy prototype/extensibility forwarding and non-extensible prototype invariants |
