...
| `node_modules_commonjs_module_exports_define_property_create_from_entries` | narrow CommonJS package `module.exports = Object.defineProperty(Object.create(proto, Object.fromEntries(...)), key, descriptor)` descriptor-map metadata from the target plus the defined property |
...
| `node_modules_commonjs_module_exports_define_property_define_properties_from_entries` | narrow CommonJS package `module.exports = Object.defineProperty(Object.defineProperties({}, Object.fromEntries(...)), key, descriptor)` descriptor-map metadata from the target plus the defined property |
