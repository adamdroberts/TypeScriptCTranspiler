...
| `node_modules_commonjs_module_exports_define_properties_create_from_entries` | narrow CommonJS package `module.exports = Object.defineProperties(Object.create(proto), Object.fromEntries(...))` descriptor-map metadata from a prototype-linked target |
...
| `node_modules_commonjs_module_exports_object_create_from_entries` | narrow CommonJS package `module.exports = Object.create(proto, Object.fromEntries(...))` descriptor-map metadata |
...
| `node_modules_commonjs_module_exports_object_wrapper_create_from_entries` | narrow CommonJS package `module.exports = Object.freeze(Object.create(proto, Object.fromEntries(...)))` descriptor-map metadata |
...
| `node_modules_commonjs_module_exports_object_wrapper_create_from_entries_variants` | narrow CommonJS package wrapped `Object.create(proto, Object.fromEntries(...))` descriptor-map metadata through `Object.seal`, `Object.preventExtensions`, and `Object.setPrototypeOf` |
