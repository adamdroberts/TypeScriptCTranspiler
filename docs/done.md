...
| `dynamic_require` | top-level finite const string `require(name)` resolved as an AOT module edge, including static concatenation, template expressions, side-effect-only conditionals, and value-returning `module.exports` dispatch |
