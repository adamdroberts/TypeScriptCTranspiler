...
- Generated-C DCE recognizes unused pure `Promise.resolve(...)` calls with side-effect-free primitive-returning `Array.isArray(...)`, `Object.is(...)`, `Object.hasOwn(...)`, `URL.canParse(...)`, and `Reflect.has(...)` results. Test: `generated_c_dce_const`
