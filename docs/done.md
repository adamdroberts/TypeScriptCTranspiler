...
- Generated-C DCE prunes unused valid `os.userInfo(...)` calls and direct field reads, including named/namespace imports, literal UTF-8 options, explicit `undefined` defaults, and primitive `Promise.resolve(...)` inputs. Test: `generated_c_dce_const`
