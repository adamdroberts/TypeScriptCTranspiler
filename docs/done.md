...
| `node_modules_commonjs_module_exports_object_assign_create_from_entries_target_named` | narrow CommonJS package `module.exports = Object.assign(Object.create(proto, Object.fromEntries(...)), { ... })` descriptor-map metadata from the target plus later static sources |
