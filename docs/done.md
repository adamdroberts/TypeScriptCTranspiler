...
- BigInt literals (`0n`, `0xfn`, `0o77n`, `0b101n`), `BigInt(value, ...ignored)`, arithmetic/comparison/equality, unary minus, compound arithmetic assignment, `typeof`, `.toString(radix?, ...ignored)`, `.toLocaleString(...ignored)`, `.valueOf(...ignored)`, and inherited `hasOwnProperty` / `propertyIsEnumerable` backed by GMP. Tests: `bigint`, `symbol_bigint_object_methods`
