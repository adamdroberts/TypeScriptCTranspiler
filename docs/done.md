...
| `node_modules_commonjs_module_exports_define_properties_target_from_entries` | narrow CommonJS package `module.exports = Object.defineProperties(api, Object.fromEntries(...))` named/default metadata from a static declared-object target plus descriptor-map metadata |
...
| `node_modules_commonjs_module_exports_define_properties_wrapper_target_from_entries` | narrow CommonJS package `module.exports = Object.defineProperties(Object.freeze(api), Object.fromEntries(...))` named/default metadata from a static wrapper target plus descriptor-map metadata |
| `node_modules_commonjs_module_exports_define_properties_from_entries` | narrow CommonJS package `module.exports = Object.defineProperties({}, Object.fromEntries(...))` descriptor-map metadata |
