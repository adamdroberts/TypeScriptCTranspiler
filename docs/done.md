...
- Generated-C DCE uses exact static string `Object.values(...)` Set source lengths, enabling unused in-range `.with(...)` calls after duplicate value elimination to be pruned. Test: `generated_c_dce_const`
