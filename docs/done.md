...
| `function_integrity` | stable boxed direct function identity, own length metadata, function seal/freeze state, and trapless function Proxy integrity forwarding |
