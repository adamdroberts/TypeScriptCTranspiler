...
Verify all at once: `TSC2C_NO_GC=1 bun tests/e2e/run.ts` -> 555 passed.
...
| `node_modules_commonjs_object_assign_exports` | narrow CommonJS package `Object.assign(exports, object)` data/default export mutation |
