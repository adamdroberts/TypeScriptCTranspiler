...
| `function_integrity` | stable boxed direct function identity, own length/name metadata, typed function Object helpers, function seal/freeze state, and trapless function Proxy integrity forwarding |
