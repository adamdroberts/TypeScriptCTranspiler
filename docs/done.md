...
- Generated-C DCE prunes unused immediate `Promise.resolve(...).then(...)`, `Promise.reject(...).catch(...)`, and settled `finally(...)` chains when their direct callbacks are side-effect-free. Test: `generated_c_dce_const`
