...
- Generated-C DCE prunes unused `Promise.try(...)` calls when the direct callback is empty or returns a side-effect-free primitive value. Test: `generated_c_dce_const`
