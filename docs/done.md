...
| `function_integrity` | stable boxed direct function identity, own length/name metadata, function seal/freeze state, and trapless function Proxy integrity forwarding |
