...
| `node_modules_commonjs_function_scope_require` | function-scoped static literal CommonJS require namespace, destructured with absent-export defaults, bound-default, and direct-default calls |
...
| `node_modules_commonjs_require_destructure` | top-level literal destructured `require("pkg")` bindings plus defaults for absent narrow CommonJS named exports |
