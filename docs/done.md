...
- Dynamic property-operation diagnostics are available behind `TSC_DYNAMIC_STATS=1`, printing opt-in get/set/has/delete/own-key/descriptor counters plus object shape-update counters to stderr at process exit. Test: `dynamic_runtime_stats`
