...
| `node_modules_commonjs_module_exports_define_property_create_from_entries_primitives` | narrow CommonJS package primitive-only `module.exports = Object.defineProperty(Object.create(proto, Object.fromEntries(...)), key, descriptor)` metadata without whole-value descriptor-map emission |
...
| `node_modules_commonjs_module_exports_wrapper_define_property_create_from_entries_primitives` | narrow CommonJS package primitive-only `module.exports = Object.freeze(Object.defineProperty(Object.create(proto, Object.fromEntries(...)), key, descriptor))` metadata without whole-value descriptor-map emission |
| `node_modules_commonjs_module_exports_wrapper_define_property_create_from_entries_primitives_variants` | narrow CommonJS package primitive-only wrapped `Object.defineProperty(Object.create(proto, Object.fromEntries(...)), key, descriptor)` metadata through `Object.seal`, `Object.preventExtensions`, and `Object.setPrototypeOf` without whole-value descriptor-map emission |
