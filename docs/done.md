...
- Generated C omits provably unreferenced non-exported top-level function declarations, lifted top-level arrow/function-expression constants, and conservative no-side-effect top-level class declarations before handing code to gcc. Tests: `generated_c_dce`, `generated_c_dce_lifted_arrow`, `generated_c_dce_class`
