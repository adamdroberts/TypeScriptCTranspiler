...
- Generated C omits provably unreferenced non-exported top-level function declarations and lifted top-level arrow/function-expression constants before handing code to gcc. Tests: `generated_c_dce`, `generated_c_dce_lifted_arrow`
