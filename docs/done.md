...
- Direct CommonJS `module.exports = require("./local.js")` assignments expose the target's supported named `exports.*` metadata and preserve require-bound whole-object reads. Test: `node_modules_commonjs_relative_require_object_named`
