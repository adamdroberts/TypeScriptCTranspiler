...
- **Phase 14 — npm integration**
  ...
  - Basic `allowJs: true` package-source loading is implemented for pure ESM JavaScript packages, including package-local default imports and default/namespace re-export barrels over package-local JavaScript modules; broader JS package patterns remain active work.
