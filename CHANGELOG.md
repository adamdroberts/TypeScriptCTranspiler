...
### Changed
- Added opt-in dynamic property-operation and object shape-update runtime diagnostics via `TSC_DYNAMIC_STATS=1`, with e2e support for per-case runtime env files and stderr substring assertions. Test: `dynamic_runtime_stats`.
