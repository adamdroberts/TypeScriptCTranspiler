...
- Standard field decorators now evaluate during module initialization for named instance and static fields, with direct decorator functions receiving dynamic context objects containing `kind`, `name`, `static`, and `private`. Field replacement remains deferred. Test: `field_decorator_basic`.
