...
### Changed
- Generated-C DCE now prunes unused direct numeric field reads from pure `process.memoryUsage(...)` and `process.resourceUsage(...)` calls, including primitive `Promise.resolve(...)` inputs. Test: `generated_c_dce_const`.
