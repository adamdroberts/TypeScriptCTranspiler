...
### Changed
- Generated-C DCE now also omits provably unreferenced non-exported top-level side-effect-free `const` primitive/array/object literals and pure literal expressions. Test: `generated_c_dce_const`.
